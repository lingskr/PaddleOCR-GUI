...
class MainWindow(QMainWindow):
    ...
    def __add_ocr_results(self,result):
        ...
        for i in range(len(boxes)):
            if len(boxes[i]) >= 4:  # Ensure there are at least four points for a rectangle
                x1 = boxes[i][0][0]
                y1 = boxes[i][0][1]
                x2 = boxes[i][2][0]
                y2 = boxes[i][2][1]
                ...
                print(f"Skipping box {i} due to insufficient points: {boxes[i]}")
